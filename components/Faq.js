...
const Faq = () => {
    ...
    const drawerContent = (
        <View style={styles.drawerContent}>
            ...
            <TouchableOpacity style={styles.drawerOption} onPress={() => RedirectPage('Farechart')}>
                <Transit width="24" height="24" />
                <Text style={styles.drawerOptionText}>Fare Chart</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.drawerOption} onPress={() => RedirectPage('Faq')}>
                <FAQ width="24" height="24" />
                <Text style={styles.drawerOptionText}>FAQ</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.drawerOption} onPress={() => RedirectPage('Helpandsupport')}>
                <Help width="24" height="24" />
                <Text style={styles.drawerOptionText}>Help and Support</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.drawerOption} onPress={() => RedirectPage('Shareapp')}>
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.shadowBox}>
                <Text style={styles.rideTitle}>Frequently Asked Questions</Text>
                <View style={styles.separator}></View>
                <View style={styles.textContainer}>
                    <Text style={styles.texttab}>Q: How do I pay for my ride?</Text>
                    <Text style={styles.texttab}>A: You can pay for your ride in cash to the driver at the end of your trip.</Text>
                </View>
                <View style={styles.textContainer}>
                    <Text style={styles.texttab}>Q: Can I schedule a ride in advance?</Text>
                    <Text style={styles.texttab}>A: No, scheduling a ride in advance is not available in this version of the app.</Text>
                </View>
                {/* Add more FAQ items as needed */}
                <View style={styles.textContainer}>
                    <Text style={styles.texttab}>Q: Do you accept cash payments?</Text>
                    <Text style={styles.texttab}>A: Yes, we accept cash payments for your convenience. Simply pay the driver in cash at the end of your ride.</Text>
                </View>
            </View>
        </View>
    );
