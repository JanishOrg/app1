    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.welcomeText}> Fare Chart </Text>
            </View>
            {isDrawerOpen && (
            ...
            <View style={styles.chartContainer}>
                <Text style={styles.chartTitle}>Fare Chart (Rupees)</Text>
                <View style={styles.chartRow}>
                    <Text style={styles.chartItem}>Distance (km)</Text>
                    <Text style={styles.chartItem}>Cost (INR)</Text>
                </View>
                <View style={styles.chartRow}>
                    <Text style={styles.chartItem}>0-5</Text>
                    <Text style={styles.chartItem}>₹50</Text>
                </View>
                <View style={styles.chartRow}>
                    <Text style={styles.chartItem}>5-10</Text>
                    <Text style={styles.chartItem}>₹80</Text>
                </View>
                <View style={styles.chartRow}>
                    <Text style={styles.chartItem}>10-15</Text>
                    <Text style={styles.chartItem}>₹100</Text>
                </View>
                <View style={styles.chartRow}>
                    <Text style={styles.chartItem}>15-20</Text>
                    <Text style={styles.chartItem}>₹120</Text>
                </View>
            </View>
        </View>
    );
